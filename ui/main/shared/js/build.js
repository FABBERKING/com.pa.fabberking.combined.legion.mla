var Build = (function() {
    ...
    {
        "/pa/units/land/titan_structure/titan_structure.json": ["utility", 0, {row: 1, column: 0}],
        "/pa/units/land/control_module/control_module.json": ["utility", 1, {row: 1, column: 1}],
    ...
    //    "/pa/units/land/metal_extractor_adv/metal_extractor_adv.json": ["utility", 4, {row: 0, column: 4}],
        ...
        "/pa/units/orbital/delta_v_engine/delta_v_engine.json": ["utility", 7, {row: 2, column: 1}],
        "/pa/units/land/radar_adv/radar_adv.json": ["utility", 8, {row: 2, column: 2}],
    ...
    //    "/pa/units/land/metal_extractor/metal_extractor.json": ["utility", 10, {row: 1, column: 4}],
        ...
        "/pa/units/land/land_barrier/land_barrier.json": ["utility", 12, {row: 3, column: 0}],
        "/pa/units/land/teleporter/teleporter.json": ["utility", 13, {row: 3, column: 1}],
    ...
    //    "/pa/units/land/metal_storage/metal_storage.json": ["utility", 16, {row: 2, column: 4}],
        ...
        "/pa/units/land/artillery_long/artillery_long.json": ["combat", 2, {row: 0, column: 3}],
        "/pa/units/land/tactical_missile_launcher/tactical_missile_launcher.json": ["combat", 3, {row: 1, column: 5}],
        "/pa/units/land/nuke_launcher/nuke_launcher.json": ["combat", 4, {row: 0, column: 6}],

        "/pa/units/land/laser_defense/laser_defense.json": ["combat", 6, {row: 2, column: 1}],
        "/pa/units/land/air_defense_adv/air_defense_adv.json": ["combat", 7, {row: 2, column: 2}],
        "/pa/units/land/artillery_unit_launcher/artillery_unit_launcher.json": ["combat", 8, {row: 2, column: 3}],
        "/pa/units/sea/torpedo_launcher_adv/torpedo_launcher_adv.json": ["combat", 9, {row: 2, column: 5}],
        "/pa/units/land/anti_nuke_launcher/anti_nuke_launcher.json": ["combat", 10, {row: 2, column: 6}],

        "/pa/units/land/laser_defense_single/laser_defense_single.json": ["combat", 12, {row: 3, column: 1}],
        "/pa/units/land/air_defense/air_defense.json": ["combat", 13, {row: 3, column: 2}],
        "/pa/units/land/artillery_short/artillery_short.json": ["combat", 14, {row: 3, column: 3}],
        "/pa/units/sea/torpedo_launcher/torpedo_launcher.json": ["combat", 15, {row: 3, column: 5}],
        "/pa/units/orbital/ion_defense/ion_defense.json": ["combat", 16, {row: 3, column: 6}],
        ...
        "/pa/units/land/bot_nanoswarm/bot_nanoswarm.json": ["bot", 11, {row: 2, column: 5}],
        ...
        "/pa/units/air/fighter_adv/fighter_adv.json": ["air", 7, {row: 2, column: 1}],
        "/pa/units/air/gunship/gunship.json": ["air", 8, {row: 2, column: 2}],
        "/pa/units/air/bomber_adv/bomber_adv.json": ["air", 9, {row: 2, column: 3}],
        "/pa/units/air/bomber_heavy/bomber_heavy.json": ["air", 10, {row: 2, column: 4}],
        "/pa/units/air/strafer/strafer.json": ["air", 10, {row: 2, column: 5}],
        ...
        "/pa/units/air/solar_drone/solar_drone.json": ["air", 17, {row: 3, column: 5}],


        "/pa/units/sea/drone_carrier/carrier/carrier.json": ["sea", 0, {row: 1, column: 0}],

        "/pa/units/sea/fabrication_ship_adv/fabrication_ship_adv.json": ["sea", 6, {row: 2, column: 0}],
        "/pa/units/sea/battleship/battleship.json": ["sea", 7, {row: 2, column: 1}],
        "/pa/units/sea/missile_ship/missile_ship.json": ["sea", 8, {row: 2, column: 2}],
        "/pa/units/sea/nuclear_sub/nuclear_sub.json": ["sea", 9, {row: 2, column: 3}],
        "/pa/units/sea/hover_ship/hover_ship.json": ["sea", 10, {row: 2, column: 4}],

        "/pa/units/sea/fabrication_ship/fabrication_ship.json": ["sea", 12, {row: 3, column: 0}],
        "/pa/units/sea/frigate/frigate.json": ["sea", 13, {row: 3, column: 1}],
        "/pa/units/sea/destroyer/destroyer.json": ["sea", 14, {row: 3, column: 2}],
        "/pa/units/sea/attack_sub/attack_sub.json": ["sea", 15, {row: 3, column: 3}],
        "/pa/units/sea/sea_scout/sea_scout.json": ["sea", 16, {row: 3, column: 4}],
        ...
        "/pa/units/orbital/orbital_battleship/orbital_battleship.json": ["orbital", 0, {row: 1, column: 0}],

        "/pa/units/orbital/solar_array/solar_array.json": ["orbital", 6, {row: 2, column: 0}],
        "/pa/units/orbital/orbital_laser/orbital_laser.json": ["orbital", 7, {row: 2, column: 1}],
        "/pa/units/orbital/radar_satellite_adv/radar_satellite_adv.json": ["orbital", 8, {row: 2, column: 2}],
        "/pa/units/orbital/orbital_railgun/orbital_railgun.json": ["orbital", 9, {row: 2, column: 3}],
        ...
        "/pa/units/orbital/orbital_probe/orbital_probe.json": ["orbital", 16, {row: 3, column: 4}],
      ...
      "/pa/units/land/l_artillery_long/l_artillery_long.json": ["combat", 2, { row: 0, column: 2, titans: true }],
    ...
    //  "/pa/units/land/l_nuke_launcher/l_nuke_launcher.json": ["L_combat", 4, { row: 0, column: 4, titans: true }],
      ...
      "/pa/units/land/l_air_defense_adv/l_air_defense_adv.json": ["combat", 7, { row: 1, column: 2, titans: true }],
      ...
      //"/pa/units/land/l_air_defense/l_air_defense.json": ["combat", 13, { row: 2, column: 2, titans: true }],
    //  "/pa/units/land/l_artillery_short/l_artillery_short.json": ["L_combat", 14, { row: 2, column: 2, titans: true }],
      "/pa/units/sea/l_torpedo_launcher/l_torpedo_launcher.json": ["combat", 15, { row: 3, column: 4, titans: true }],
    //  "/pa/units/orbital/l_ion_defense/l_ion_defense.json": ["combat", 16, { row: 3, column: 7, titans: true }],

    //  "/pa/units/land/l_control_module/l_control_module.json": ["L_utility", 1, { row: 0, column: 1, titans: true }],
      "/pa/units/land/l_energy_plant_adv/l_energy_plant_adv.json": ["utility", 3, { row: 1, column: 3, titans: true }],
      "/pa/units/land/l_mex_adv/l_mex_adv.json": ["utility", 4, { row: 1, column: 4, titans: true }],
    ...
    //  "/pa/units/land/l_radar_adv/l_radar_adv.json": ["L_utility", 8, { row: 1, column: 2, titans: true }],
      "/pa/units/land/l_energy_plant/l_energy_plant.json": ["utility", 9, { row: 2, column: 3, titans: true }],
      "/pa/units/land/l_mex/l_mex.json": ["utility", 10, { row: 2, column: 4, titans: true }],
    ...
    //  "/pa/units/land/l_teleporter/l_teleporter.json": ["L_utility", 13, { row: 2, column: 1, titans: true }],
      ...
      "/pa/units/orbital/l_orbital_battleship/l_orbital_battleship.json": [        "L_orbital",        6,        { row: 2, column: 0, titans: true }      ],
      "/pa/units/orbital/l_orbital_railgun/l_orbital_railgun.json": [        "L_orbital",        9,        { row: 2, column: 3, titans: true }      ],
      "/pa/units/orbital/l_orbital_laser/l_orbital_laser.json": [        "L_orbital",        7,        { row: 2, column: 1, titans: true }      ],
      "/pa/units/orbital/l_radar_satellite_adv/l_radar_satellite_adv.json": [        "L_orbital",        8,        { row: 2, column: 2, titans: true }      ],
      "/pa/units/orbital/l_orbital_dropper/l_orbital_dropper.json": [        "orbital_structure",        16,        { row: 3, column: 3, titans: true }      ],
    //  "/pa/units/orbital/l_mining_platform/l_mining_platform.json": [        "L_orbital_structure",        13,        { row: 2, column: 1, titans: true }      ],
      "/pa/units/orbital/l_orbital_factory/l_orbital_factory.json": [        "orbital_structure",        14,        { row: 2, column: 2, titans: true }      ],
      ...
      "/pa/units/orbital/l_orbital_probe/l_orbital_probe.json": [        "L_orbital",        16,        { row: 3, column: 4, titans: true }      ],
      ...
      "/pa/units/orbital/l_defense_satellite/l_defense_satellite.json": [        "orbital_structure",        12,        { row: 2, column: 0, titans: true }      ],
...
//      "/pa/units/land/l_titan_structure/l_titan_structure.json": [        "L_utility",        0,        { row: 0, column: 0, titans: true }      ],
    ...
    "/pa/units/addon/pounder/pounder.json": ["combat", 0, { row: 1, column: 3 }],
...
//    "/pa/units/addon/adv_metal_storage/adv_metal_storage.json": ["utility", 0, { row: 0, column: 6 }],
    ...
    "/pa/units/l_addon/anti_orbital_armor/lynx.json": ["L_vehicle", 0, { row: 3, column: 6, titans: true }],
	...
	"/pa/units/addon/basic_missile_defence/basic_missile_defence.json": ["combat", 0, { row: 2, column: 6 }],
