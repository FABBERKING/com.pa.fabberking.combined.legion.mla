var Build = (function() {
    ...
    HotkeyModel.SpecIdToGridMap = {
			//UTILITY////////////////////////////////////////////////
			"/pa/units/land/energy_plant_adv/energy_plant_adv.json": ["orbital_structure", 3],
			"/pa/units/land/metal_extractor_adv/metal_extractor_adv.json": ["orbital_structure", 4],			
			"/pa/units/land/radar_adv/radar_adv.json": ["orbital_structure", 2],
			"/pa/units/land/radar/radar.json": ["orbital_structure", 8],
			"/pa/units/land/energy_plant/energy_plant.json": ["orbital_structure", 9],
			"/pa/units/land/metal_extractor/metal_extractor.json": ["orbital_structure", 10],
			"/pa/units/land/land_barrier/land_barrier.json": ["orbital_structure", 14],
			"/pa/units/land/teleporter/teleporter.json": ["orbital_structure", 15],
			"/pa/units/land/energy_storage/energy_storage.json": ["orbital_structure", 330],
			"/pa/units/land/metal_storage/metal_storage.json": ["orbital_structure", 340],
			
			"///pa/units/land/l_energy_plant_adv/l_energy_plant_adv.json": [ "orbital_structure", 3 ],
			"///pa/units/land/l_mex_adv/l_mex_adv.json": [ "orbital_structure", 4 ],
			
			"///pa/units/land/l_radar_adv/l_radar_adv.json": [ "orbital_structure", 140 ],
			"///pa/units/land/l_energy_plant/l_energy_plant.json": [ "orbital_structure", 9 ],
			"///pa/units/land/l_mex/l_mex.json": [ "orbital_structure", 10 ],
			"///pa/units/land/l_land_barrier/l_land_barrier.json": [ "orbital_structure", 14 ],
			"///pa/units/land/l_teleporter/l_teleporter.json": [ "orbital_structure", 250 ],
			"///pa/units/land/l_radar/l_radar.json": [ "orbital_structure", 260 ],
			"/pa/units/land/l_storage/l_storage.json": [ "orbital_structure", 16 ],
			"/pa/units/land/l_shield_gen/l_shield_gen.json": [ "orbital_structure", 6 ],
			
			"/pa/units/orbital/l_mining_platform/l_mining_platform.json": [ "factory", 14 ],
			"/pa/units/orbital/mining_platform/mining_platform.json": ["factory", 15],
			"/pa/units/air/l_flying_teleporter/l_flying_teleporter.json": [ "combat", 6 ],
			
			"//pa/units/land/l_titan_structure/l_titan_structure.json": [ "factory", 60 ],
			"/pa/units/land/titan_structure/titan_structure.json": ["orbital_structure", 13],
			
			
			"///pa/units/orbital/l_deep_space_radar/l_deep_space_radar.json": [ "orbital_structure", 14 ],
			

			//FACTORY//////////////////////////////////////////////////
			"/pa/units/land/l_titan_bot/l_titan_bot.json": [ "combat", 2 ],
			"/pa/units/land/l_titan_vehicle/l_titan_vehicle.json": [ "combat", 4 ],
			//naval
			"/pa/units/air/l_titan_air/l_titan_air.json": [ "combat", 0 ],
			"/pa/units/orbital/l_titan_orbital/l_titan_orbital.json": [ "factory", 7 ],
			
			
			"/pa/units/land/titan_bot/titan_bot.json": ["combat", 3],
			"/pa/units/land/titan_vehicle/titan_vehicle.json": ["combat", 5],
			//naval
			"/pa/units/air/titan_air/titan_air.json": ["combat", 1],
			"/pa/units/orbital/titan_orbital/titan_orbital.json": ["factory", 6],
			...
			"/pa/units/land/bot_factory_adv/bot_factory_adv.json": ["combat", 10],
			"/pa/units/land/vehicle_factory_adv/vehicle_factory_adv.json": ["combat", 11],
			"/pa/units/sea/naval_factory_adv/naval_factory_adv.json": ["combat", 8],
			"/pa/units/air/air_factory_adv/air_factory_adv.json": ["combat", 9],
			"/pa/units/orbital/orbital_factory/orbital_factory.json": ["factory", 16],
			...
			"/pa/units/land/bot_factory/bot_factory.json": ["combat", 16],
			"/pa/units/land/vehicle_factory/vehicle_factory.json": ["combat", 17],			
			"/pa/units/sea/naval_factory/naval_factory.json": ["combat", 14],
			"/pa/units/air/air_factory/air_factory.json": ["combat", 15],
			"/pa/units/orbital/orbital_launcher/orbital_launcher.json": ["combat", 13],
			
			
			//COMBAT////////////////////////////////////////////////////
			"/pa/units/land/control_module/control_module.json": ["orbital_structure", 1],
			"///pa/units/land/l_anti_nuke_launcher/l_anti_nuke_launcher.json": [ "utility", 100 ],
			"///pa/units/land/l_nuke_launcher/l_nuke_launcher.json": [ "combat", 200 ],
			"/pa/units/land/l_rocket_barrage/l_rocket_barrage.json": [ "utility", 0 ],
			"///pa/units/orbital/l_delta_v_engine/l_delta_v_engine.json": [ "combat", 500 ],
			
			"/pa/units/land/laser_defense_adv/laser_defense_adv.json": ["utility", 1],
			"/pa/units/land/anti_nuke_launcher/anti_nuke_launcher.json": ["utility", 11],
			"/pa/units/land/nuke_launcher/nuke_launcher.json": ["utility", 5],
			"/pa/units/land/tactical_missile_launcher/tactical_missile_launcher.json": ["utility", 4],
			"/pa/units/land/l_flame_turret/l_flame_turret.json": [ "orbital_structure", 0 ],
			"/pa/units/orbital/delta_v_engine/delta_v_engine.json": ["orbital_structure", 7],
			
			"/pa/units/land/l_t1_turret_adv/l_t1_turret_adv.json": [ "utility", 6 ],
			"/pa/units/land/l_air_defense_adv/l_air_defense_adv.json": [ "utility", 12 ],			
			"///pa/units/sea/l_torpedo_launcher_adv/l_torpedo_launcher_adv.json": [ "combat", 140 ],
			"/pa/units/orbital/l_defense_satellite/l_defense_satellite.json": [ "factory", 12 ],
			"/pa/units/land/l_artillery_long/l_artillery_long.json": [ "utility", 2 ],
			"/pa/units/orbital/l_orbital_dropper/l_orbital_dropper.json": [ "factory", 8 ],
			
			"///pa/units/land/l_t1_turret_basic/l_t1_turret_basic.json": [ "combat", 180 ],
			"/pa/units/land/air_defense_adv/air_defense_adv.json": ["utility", 8],
			"/pa/units/sea/torpedo_launcher_adv/torpedo_launcher_adv.json": ["utility", 10],
			"/pa/units/orbital/defense_satellite/defense_satellite.json": ["factory", 13],
			"/pa/units/land/artillery_long/artillery_long.json": ["utility", 3],
			"/pa/units/land/unit_cannon/unit_cannon.json": ["combat", 7],
			
			"/pa/units/land/laser_defense/laser_defense.json": ["utility", 7],
			"///pa/units/land/l_air_defense/l_air_defense.json": [ "combat", 250 ],
			"///pa/units/sea/l_torpedo_launcher/l_torpedo_launcher.json": [ "combat", 260 ],
			"///pa/units/orbital/l_ion_defense/l_ion_defense.json": [ "combat", 270 ],
			"///pa/units/land/l_artillery_short/l_artillery_short.json": [ "combat", 280 ],
			"/pa/units/land/l_swarm_hive/l_swarm_hive.json": [ "orbital_structure", 12 ],
			
			"/pa/units/land/laser_defense_single/laser_defense_single.json": ["utility", 13],
			"/pa/units/land/air_defense/air_defense.json": ["utility", 14],
			"/pa/units/sea/torpedo_launcher/torpedo_launcher.json": ["utility", 16],
			"/pa/units/orbital/ion_defense/ion_defense.json": ["utility", 17],
			"/pa/units/land/artillery_short/artillery_short.json": ["utility", 15],
			"/pa/units/land/artillery_unit_launcher/artillery_unit_launcher.json": ["utility", 9],
