var Build = (function() {
    ...
    //    "/pa/units/land/metal_storage/metal_storage.json": ["utility", 16, {row: 2, column: 4}],
        ...
        "/pa/units/land/titan_vehicle/titan_vehicle.json": ["factory", 5, {row: 0, column: 5}],

        "/pa/units/land/unit_cannon/unit_cannon.json": ["factory", 6, {row: 1, column: 1}],
        "/pa/units/sea/naval_factory_adv/naval_factory_adv.json": ["factory", 7, {row: 1, column: 2}],
        "/pa/units/air/air_factory_adv/air_factory_adv.json": ["factory", 8, {row: 1, column: 3}],
        "/pa/units/land/bot_factory_adv/bot_factory_adv.json": ["factory", 9, {row: 1, column: 4}],
        "/pa/units/land/vehicle_factory_adv/vehicle_factory_adv.json": ["factory", 10, {row: 1, column: 5}],

        "/pa/units/orbital/orbital_launcher/orbital_launcher.json": ["factory", 12, {row: 2, column: 1}],
        "/pa/units/sea/naval_factory/naval_factory.json": ["factory", 13, {row: 2, column: 2}],
        "/pa/units/air/air_factory/air_factory.json": ["factory", 14, {row: 2, column: 3}],
        "/pa/units/land/bot_factory/bot_factory.json": ["factory", 15, {row: 2, column: 4}],
        "/pa/units/land/vehicle_factory/vehicle_factory.json": ["factory", 16, {row: 2, column: 5}],


        "/pa/units/land/laser_defense_adv/laser_defense_adv.json": ["combat", 0, {row: 0, column: 1}],

        "/pa/units/land/artillery_long/artillery_long.json": ["combat", 2, {row: 0, column: 3}],
        "/pa/units/land/tactical_missile_launcher/tactical_missile_launcher.json": ["combat", 3, {row: 0, column: 5}],
        "/pa/units/land/nuke_launcher/nuke_launcher.json": ["combat", 4, {row: 0, column: 6}],

        "/pa/units/land/laser_defense/laser_defense.json": ["combat", 6, {row: 1, column: 1}],
        ...
        "/pa/units/orbital/defense_satellite/defense_satellite.json": ["orbital_structure", 12, {row: 1, column: 0}],
	  ...
	  "/pa/units/air/l_flying_teleporter/l_flying_teleporter.json": ["factory", 0, {row: 1, column: 0, titans: true }],
    ...
    //  "/pa/units/land/l_vehicle_factory/l_vehicle_factory.json": ["L_factory", 16, { row: 2, column: 4, titans: true }],
      ...
      "/pa/units/land/l_shield_gen/l_shield_gen.json": ["combat", 1, { row: 0, column: 2, titans: true }],
    //  "/pa/units/land/l_nuke_launcher/l_nuke_launcher.json": ["L_combat", 4, { row: 0, column: 4, titans: true }],
      "/pa/units/land/l_t1_turret_adv/l_t1_turret_adv.json": ["combat", 6, { row: 1, column: 0, titans: true }],
    ...
    //  "/pa/units/land/l_radar/l_radar.json": ["L_utility", 14, { row: 2, column: 2, titans: true }],
      ...
      "/pa/units/orbital/l_orbital_dropper/l_orbital_dropper.json": [        "orbital_structure",        16,        { row: 2, column: 3, titans: true }      ],
...
//      "/pa/units/land/l_titan_structure/l_titan_structure.json": [        "L_utility",        0,        { row: 0, column: 0, titans: true }      ],
    ...
    "/pa/units/addon/pounder/pounder.json": ["combat", 0, { row: 1, column: 8 }],
    "/pa/units/addon/anti_missile_tower/anti_missile_tower.json": ["combat", 0, { row: 0, column: 8 }],
...
//    "/pa/units/addon/adv_metal_storage/adv_metal_storage.json": ["utility", 0, { row: 0, column: 6 }],
    "/pa/units/addon/adv_energy_storage/adv_energy_storage.json": ["utility", 0, { row: 2, column: 5 }],
    "/pa/units/addon/solar_cell/solar_cell.json": ["utility", 0, { row: 2, column: 4 }],

    "/pa/units/addon/fab_tower/fab_tower.json": ["factory", 0, { row: 2, column: 6 }],
    "/pa/units/addon/adv_fab_tower/adv_fab_tower.json": ["factory", 0, { row: 1, column: 6 }],
...
//    "/pa/units/l_addon/adv_fab_turret/adv_fab_turret.json": ["L_factory", 0, { row: 1, column: 5, titans: true }],
    ...
    "/pa/units/land/artillery_comet/artillery_comet.json": ["combat", 0, { row: 1, column: 7, titans: true }],
    "/pa/units/land/artillery_morningstar/artillery_morningstar.json": ["combat", 0, { row: 0, column: 7, titans: true }],
    "/pa/units/sea/bolide/bolide.json": ["sea", 0, { row: 1, column: 5, titans: true }],
    "/pa/units/land/bot_sun/bot_sun.json": ["bot", 0, { row: 2, column: 8, titans: true }],
